...
export const lasuiteMeetBackendDefinition: ServiceDefinition = {
	...
	volumes: [],
	environment: [
		{ key: "DB_HOST", defaultValue: "postgresql", secret: false, description: "PostgreSQL host", required: true },
		{ key: "DB_NAME", defaultValue: "meet", secret: false, description: "PostgreSQL database name", required: true },
		{ key: "DB_USER", defaultValue: "meet", secret: false, description: "PostgreSQL user", required: true },
		{ key: "DB_PASSWORD", defaultValue: "", secret: true, description: "PostgreSQL password", required: true },
		{ key: "DB_PORT", defaultValue: "5432", secret: false, description: "PostgreSQL port", required: true },
		{
		...
		{ key: "LIVEKIT_API_KEY", defaultValue: "meet", secret: false, description: "LiveKit API key", required: true },
		{
