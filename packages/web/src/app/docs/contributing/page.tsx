...
export default function ContributingPage() {
  return (
    <>
      <h1>Contributing</h1>
      <p>
        better-openclaw is open source and welcomes contributions. Whether
        you&apos;re fixing a bug, adding a service, improving docs, or building
        a new feature — here&apos;s how to get started.
      </p>
...
└── turbo.json`}</code>
      ...
      <ul>
        <li>Node.js 20+</li>
        <li>pnpm 9+ (<code>npm install -g pnpm</code>)</li>
...
pnpm --filter web dev`}</code>
      ...
      <p>
        See the{" "}
        <Link href="/docs/services/adding">Adding Services guide</Link> for
        the full walkthrough. In summary:
      </p>
      <ol>
        <li>
          Create a new file in{" "}
          <code>packages/core/src/services/[category]/</code>
        </li>
        <li>
          Implement the <code>ServiceDefinition</code> interface
        </li>
        <li>
          Register it in the category index and main service registry
        </li>
        <li>
          Test with <code>--dry-run</code> and then with{" "}
      ...
      <ol>
        <li>
          ...
          <code>packages/core/src/skills/[pack-name]/</code>
        </li>
        <li>
          Create the pack definition in{" "}
          <code>packages/core/src/skills/[pack-name]/index.ts</code>
        </li>
      ...
      <ul>
        <li>
          Docs pages live in{" "}
          <code>packages/web/src/app/docs/</code>
        </li>
        <li>Each page is a Next.js page component</li>
        <li>
          Follow the existing patterns (metadata export, semantic HTML, prose
          classes)
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Run the full test suite:</strong>{" "}
          <code>pnpm test</code>
        </li>
        <li>
...
curl http://localhost:3000/api/v1/services | jq`}</code>
      ...
      <h2>License</h2>
      <p>
        better-openclaw is MIT licensed. By contributing, you agree that your
