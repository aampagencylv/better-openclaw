...
export default function EndpointsPage() {
  return (
    <>
      <h1>API Endpoints</h1>
      <p>
        Full reference for all REST API endpoints. All paths are relative to the
        base URL <code>/api/v1</code>. See the{" "}
        <Link href="/docs/api">API Overview</Link> for authentication and rate
        limiting details.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>string</td>
            <td>
              Filter by maturity: <code>stable</code>, <code>beta</code>,{" "}
  ...
  "data": {
    ...
    "services": [
      ...
      <p>
        Returns all available skill packs with their descriptions and required
        services.
      </p>
      <h3>Request</h3>
      <pre>
  ...
  "data": {
    "presets": [
      ...
      <p>
        Returns detailed information about a specific preset, including the full
        service and skill pack configuration.
      </p>
  ...
  "data": {
    ...
    "estimatedMemoryMB": 2048
      ...
      <h3>Response <code>404 Not Found</code></h3>
      <pre>
        <code>{`{
  "ok": false,
  "error": {
    ...
    "message": "Preset 'invalid-preset' does not exist"
      ...
      <p>
        Validates a stack configuration without generating any files. Useful for
        checking for conflicts, missing dependencies, and invalid options before
        generating.
      </p>
      <h3>Request Body</h3>
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>No</td>
            <td>
              Proxy type: <code>caddy</code>, <code>traefik</code>,{" "}
              <code>nginx</code>
            </td>
          </tr>
        </tbody>
  ...
  -d '{
    ...
    "skills": ["researcher"]
      ...
      <h3>Response <code>200 OK</code> (valid)</h3>
      <pre>
        <code>{`{
  "ok": true,
  "data": {
    ...
    "estimatedMemoryMB": 3072
      ...
      <h3>Response <code>400 Bad Request</code> (invalid)</h3>
      <pre>
        <code>{`{
  "ok": false,
  "error": {
    ...
    "details": {
      ...
      <p>
        Generates a complete stack configuration and returns the files as a JSON
        bundle or downloadable archive.
      </p>
      <h3>Request Body</h3>
      <table>
        <thead>
  ...
  -d '{
    ...
    "domain": "ai.example.com"
      ...
      <h3>Response <code>200 OK</code> (format: json)</h3>
      <pre>
        <code>{`{
  "ok": true,
  "data": {
    ...
    "summary": {
      ...
      <p>
        Set <code>format: &quot;tar&quot;</code> to get a downloadable{" "}
        <code>.tar.gz</code> archive instead of JSON:
      </p>
      <pre>
        <code>{`curl -X POST https://better-openclaw.dev/api/v1/generate \\
  -H "Authorization: Bearer $OPENCLAW_API_KEY" \\
  ...
  -o my-stack.tar.gz`}</code>
      ...
      <ul>
        <li>
          <Link href="/docs/api">API Overview</Link> — authentication and
          general concepts
        </li>
        <li>
        ...
        <li>
          <Link href="/docs/cli">CLI Reference</Link> — generate stacks from
          the command line
        </li>
      </ul>
    </>
