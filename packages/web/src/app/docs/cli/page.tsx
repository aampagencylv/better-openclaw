...
export default function CliReferencePage() {
  return (
    <>
      <h1>CLI Reference</h1>
      <p>
        The <code>create-better-openclaw</code> CLI is the primary way to
        generate OpenClaw stacks. It supports both an{" "}
        <Link href="/docs/cli/wizard">interactive wizard</Link> and a fully
      ...
      <p>
        If no options are provided, the CLI launches the interactive wizard. If{" "}
        <code>--yes</code> is passed, it uses defaults combined with any
        explicit flags.
      </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>—</td>
            <td>
              Comma-separated service IDs (e.g.{" "}
              <code>qdrant,redis,n8n</code>)
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>—</td>
            <td>
              Comma-separated skill pack IDs
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              Reverse proxy: <code>caddy</code>, <code>traefik</code>,{" "}
              <code>nginx</code>, or <code>none</code>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            ...
            <td>
              Enable GPU passthrough for Ollama, Whisper, etc.
            </td>
          </tr>
          <tr>
            <td>
      ...
      <p>
        Pass <code>--yes</code> to skip all interactive prompts. Combine with
        other flags to fully automate stack generation — perfect for CI/CD,
        scripts, or infrastructure-as-code workflows.
      </p>
      <pre>
...
npx create-better-openclaw my-stack \\
  ...
  --yes`}</code>
      ...
      <ul>
        <li>
          <Link href="/docs/cli/wizard">Interactive Wizard</Link> — step-by-step
          walkthrough of each prompt
        </li>
        <li>
          <Link href="/docs/api">API Reference</Link> — programmatic stack
          generation via REST
        </li>
        <li>
          <Link href="/docs/services">Service Catalog</Link> — all available
          services
        </li>
      </ul>
    </>
