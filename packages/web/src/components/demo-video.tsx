...
export function DemoVideo() {
	return (
		<section id="demo" className="relative border-y border-border/50 bg-background py-24 sm:py-32 overflow-hidden">
			...
			<div className="relative mx-auto max-w-7xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl text-center mb-16">
					...
					<p className="mt-4 text-lg text-muted-foreground">
						Watch how easily you can design, validate, and deploy an enterprise-grade AI architecture in under 5 minutes.
					</p>
				</div>
				...
				<div className="mx-auto max-w-5xl">
					...
					<div className="relative aspect-video w-full rounded-2xl border border-border/50 bg-[#0a0a0a] shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden group">
						...
						<div className="absolute inset-0 flex items-center justify-center">
							<button aria-label="Play Demo Video" className="group/btn relative flex h-20 w-20 items-center justify-center rounded-full bg-primary/20 backdrop-blur-md transition-all duration-300 hover:scale-110 hover:bg-primary/30 border border-primary/50">
						...
						<div className="absolute top-0 inset-x-0 h-12 bg-linear-to-b from-black/60 to-transparent flex items-start justify-between px-6 pt-4">
							<div className="font-mono text-xs uppercase tracking-widest text-white/50">better-openclaw architecture builder demo</div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center z-[-1] opacity-50">
                            <span className="font-mono text-muted-foreground/30 text-2xl uppercase tracking-[0.2em] pointer-events-none">[ Placeholder Video Element ]</span>
                        </div>
					</div>
				</div>
			</div>
