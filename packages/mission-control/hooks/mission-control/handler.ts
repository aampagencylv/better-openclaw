...
const CODE_EXTENSIONS = [".ts", ".js", ".tsx", ".jsx", ".py", ".rs", ".go", ".java", ".c", ".cpp", ".yml", ".yaml", ".json", ".html", ".css"];
...
export default function handler({ config, context }) {
  ...
  context.onAgentEvent?.((event) => {
    ...
    if (
      (eventType === "file:write" || eventType === "document:create") &&
      event.path
    ) {
